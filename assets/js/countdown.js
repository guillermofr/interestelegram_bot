...
(function () {
    ...
    b.applySkin = function (a, b) {
        ...
        if (c = a.stroke) {
            var g;
            typeof c == "string" ? (d = c, g = e = 1, c = "solid") : c.color == null ? c = g = e = d = null : (d = c.color || "#ffffff", e = jbeeb.Utils.isNumber(c.alpha) ? c.alpha : 1, g = c.weight || 1, c = c.style || "solid");
    ...
    b.aP = function () {
        var a = this.shadow;
        return a ? [0, a.x || 0, a.y || 0, a.s, a.c || "#ffffff", a.a || 0.4] : []
    };
    ...
    b.bh = function () {
        var a = this.inset;
        return a ? [1, a.x || 0, a.y || 0, a.s, a.c || "#ffffff", a.a || 0.4] : []
    };
    ...
    b.aq = function () {
        ...
        if (a) {
            var b = this.aQ(a.c1 || "#ffffff"),
                c = this.aQ(a.c2 || "#ffffff");
            return b > c ? [1, -a.x, -a.y, a.s1, a.c1 || "#ffffff", a.a1, 1, a.x, a.y, a.s2, a.c2 || "#ffffff", a.a2] : [1, a.x, a.y, a.s2, a.c2 || "#ffffff", a.a2, 1, -a.x, -a.y, a.s1, a.c1 || "#ffffff", a.a1]
        } else return []
    };
    b.aQ = function (a) {
    ...
    b.bD = function () {
        if (this.outline) {
            var a = this.outline;
            return [0, -a.weight, -a.weight, a.spread || 0, a.color || "#ffffff", a.alpha, 0, a.weight, -a.weight, a.spread || 0, a.color || "#ffffff", a.alpha, 0, -a.weight, a.weight, a.spread || 0, a.color || "#ffffff", a.alpha, 0, a.weight, a.weight, a.spread || 0, a.color || "#ffffff", a.alpha]
        } else return []
    };
...
(function () {
    ...
    b.init = function (a) {
        if (a) {
            ...
            if (a.textColor) {
                ...
                this.setTextColor(c.color || "#ffffff", c.alpha || 1)
            }
    ...
    b.as = function () {
        if (this.bevelText) {
            ...
            return [0, -a.x, -a.y, a.s1, a.c1 || "#ffffff", a.a1, 0, a.x, a.y, a.s2, a.c2 || "#ffffff", a.a2]
        } else return []
    };
    ...
    b.init = function () {
        ...
        var p = {
            ...
            bkgd: this.T == "flip" ? null : {
                color: ["#ffffff", 1, 0, "#686868", 1, 50, "#ffffff", 1, 50, "#535050", 1, 100],
                alpha: "v"
            },
